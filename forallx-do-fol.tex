...
\newglossaryentry{Universalquantor}{
...
\newglossaryentry{leeres Prädikat}{
...
\newglossaryentry{Hauptoperator}{
  name=Hauptoperator,
  description={Der Operator, der bei der Konstruktion von einem \gls{Satz der LEO} oder einer \glx{Formel} der LEO als Letzter genutzt wurde}
}

\newglossaryentry{Geltungsbereich}{
  name=Geltungsbereich (der LEO),
  description={Die Teilformel von einem \gls{Satz der LEO} oder einer \gls{Formel} der LEO, für den der relevante Operator der \gls{Hauptoperator} ist}
}
...
\newglossaryentry{gebundene Variable}{
...
\newglossaryentry{ungebundene Variable}{
...
Zuletzt können wir das Folgende zu Sätzen der LEO sagen:	
	\factoidbox{	
		Ein \define{Satz} der LEO ist eine Formel der LEO, welcher keine ungebundene Variable beinhaltet.}

\newglossaryentry{Satz der LEO}{
	name=Satz der LEO,
	description={Eine \gls{Formel} der LEO, welcher keine \glspl{ungebundene Variable} beinhaltet}
}
