...
\factoidbox{The interpretation $\mathbf{I}[d/\meta{c}]$ is just like the interpretation $\mathbf{I}$ except it also assigns the name $\meta{c}$ to the object~$d$.

\
\\
An object $d$ \define{satisfies} $\meta{A}(\dots\meta{x}\dots\meta{x}\dots)$ in interpretation~$\mathbf{I}$ \textbf{iff} $\meta{A}(\dots\meta{c}\dots\meta{c}\dots)$ is true in $\mathbf{I}[d/\meta{c}]$.
}
...
Armed with this notation, the rough idea is as follows. The sentence $\forall \meta{x}\meta{A}(\ldots \meta{x} \ldots \meta{x} \ldots)$ will be true in $\mathbf{I}$ iff, for any object~$d$ in the domain, $\meta{A}(\ldots \meta{c} \ldots \meta{c}\ldots)$ is true in $\mathbf{I}[d/\meta{c}]$, i.e., no matter what object (in the domain) we name with $\meta{c}$. In other words, $\forall \meta{x} \meta{A}(\ldots \meta{x} \ldots \meta{x} \ldots)$ is true iff every object in the domain satisfies $\meta{A}(\ldots \meta{x} \ldots \meta{x} \ldots)$. Similarly, the sentence $\exists \meta{x}\meta{A}$ will be true iff there is \emph{some} object that satisifes $\meta{A}(\ldots \meta{x} \ldots \meta{x} \ldots)$, i.e., $\meta{A}(\ldots \meta{c} \ldots \meta{c} \ldots)$ true in $\mathbf{I}[d/\meta{c}]$ for some object~$d$.
	\factoidbox{
