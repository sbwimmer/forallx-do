...
Complete the Lemmas left as exercises in this chapter. That is, show that the following are rule-sound:
	\begin{earg}
		\item[\textbullet] $\eor$I. (\emph{Hint}: this is  similar to the case of $\eand$E.)
		\item[\textbullet] X. (\emph{Hint}: this is similar to the case of $\enot$E.)
		\item[\textbullet] $\eif$I. (\emph{Hint}: this is similar to $\eor$E.)
		\item[\textbullet] $\eif$E.
		\item[\textbullet] IP. (\emph{Hint}: this is similar to the case of $\enot$I.)
	\end{earg}
