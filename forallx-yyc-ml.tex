...
\factoidbox{
	\begin{itemize}
		...
		\item $\meta{A}$ is a \define{modal logical truth} iff $\meta{A}$ is true at every world in every interpretation.

		\item $\meta{A}$ is a \define{modal contradiction} iff $\meta{A}$ is false at every world in every interpretation.

		\item $\meta{A}$ is \define{modally consistent} iff $\meta{A}$ is true at some world in some interpretation.
	\end{itemize}
}
