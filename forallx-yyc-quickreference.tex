...
P unless Q & $(P \eor Q)$\\
\\
\multicolumn{2}{c}{\label{SymbolisingPredicates}\textsc{Predicates}}\\ \\
...
% BEGIN: symbolising cardinality

\newpage
\section{Using identity to symbolise quantities}
...
One way to say `there are exactly $n$ Fs' is to conjoin two of the symbolisations above and say `there are at least $n$ Fs and there are at most $n$ Fs.' The following equivalent formulae are shorter:
\begin{ekey}
