...
this would not have allowed us to determine whether `$\enot B$' is a sentence. To emphasize, then:
	\factoidbox{
	  `$\meta{A}$' is a symbol (called a \define{metavariable}) in augmented English, which we use to talk about any TFL expression. 	`$A$' is a particular sentence letter of TFL.}
