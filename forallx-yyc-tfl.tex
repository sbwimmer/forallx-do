...
\problempart
Using the symbolisation key given, translate each English-language sentence into TFL.
...
\problempart
For each argument, write a symbolisation key and translate the argument as well as possible into TFL. The part of the passage in italics is there to provide context for the argument, and doesn't need to be symbolised.
\begin{earg}
