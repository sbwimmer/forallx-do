...
\begin{earg}
\item $A\eif A \therefore  A$ \vspace{.5ex} \hfill \myanswer{Invalid}
...
\solutions
\setcounter{ProbPart}{10} % next problem is K (= 11)
\problempart
...
Determine whether each collection of sentences is consistent or inconsistent. Justify your answer with a complete or partial truth table where appropriate.
\begin{earg}
\item $A \eand B$, $C\eif \enot B$, $C$ \vspace{.5ex} \hfill \myanswer{Inconsistent}
\item $A\eif B$, $B\eif C$, $A$, $\enot C$\vspace{.5ex} \hfill \myanswer{Inconsistent}
\item $A \eor B$, $B\eor C$, $C\eif \enot A$\vspace{.5ex} \hfill \myanswer{Consistent}
\item $A$, $B$, $C$, $\enot D$, $\enot E$, $F$\vspace{.5ex} \hfill \myanswer{Consistent}
\item $A \eand (B \eor C)$, $\enot(A \eand C)$, $\enot(B \eand C)$ \vspace{.5ex}\hfill \myanswer{Consistent}
\item $A \eif B$, $B \eif C$, $\enot(A \eif C)$ \vspace{.5ex} \hfill \myanswer{Inconsistent}
